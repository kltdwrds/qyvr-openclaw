...
for (const name of ["boot/config", "boot/identity", "boot/prompt", "boot/main", "boot/process", "boot/probe", "boot/mcp-bridge", "plugin/index", "plugin/transport", "plugin/authorization"]) {
